  ...
  return createPortal(
    <div className="fixed inset-0 bg-brand-coffee/20 backdrop-blur-sm flex items-center justify-center z-50 p-3 sm:p-4">
      <div className="bg-brand-cream rounded-3xl shadow-xl border border-brand-blue/10 w-full max-w-md max-h-[90vh] overflow-hidden flex flex-col p-4 sm:p-6">
        <h2 className="font-bold text-base text-brand-blue sm:text-lg mb-4 shrink-0">프로젝트 수정</h2>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="프로젝트 이름"
                  required
                  className="border border-brand-blue/20 rounded-xl w-full px-3 py-2 text-sm focus:outline-none focus:shadow-sm bg-white/50"
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  className="border border-brand-blue/20 rounded-xl w-full px-3 py-2 text-sm focus:outline-none focus:shadow-sm min-h-[80px] resize-none bg-white/50"
                />
              </div>
            </div>
